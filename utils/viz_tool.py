...
def viz_tool(episode_idx, data_dir, out_dir, cam_view=0):
    ...
    tool_pos_path = os.path.join(data_dir, f"episode_{episode_idx}/tool_pos.npy")
    ...
    for i in range(n_frames):
        ...
        img = viz_points_single_frame(raw_img, tool_points, cam_intr, cam_extr)
...
if __name__ == "__main__":
    ...
    tool_points_path = f'/mnt/sda/data/{data_name}/episode_{epi_idx}/tool_pos.npy'
    tool_points = np.load(tool_points_path)
    tool_points = tool_points[i]
    ...
    # viz_points_single_frame(img, tool_points, cam_intr[0], cam_extr[0])
    
    # data_dir = f'/mnt/sda/data/{data_name}'
    # out_dir = f'/mnt/sda/viz_tool/{data_name}'
    # viz_tool(epi_idx, data_dir, out_dir)
