...
if __name__ == '__main__':
    ...
    for n in range(epi_num):
        ...
        epi_path = f"/media/baoyu/sumsung/granular/carrots/episode_{i}/camera_{j}"
        image_path = f"/media/baoyu/sumsung/granular/carrots/episode_{i}/camera_{j}"
        video_path = f"/media/baoyu/sumsung/video/granular/carrots/video_{i}.mp4" 
