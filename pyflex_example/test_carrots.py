...
parser.add_argument('--cam_view', type=int, default=1)
...
if args.cam_view == 0: # front view
    des_dir = '../test_carrots/cam_view_0'
    os.system('mkdir -p ' + des_dir)
...
elif args.cam_view == 1: # lower right corner
    des_dir = '../test_carrots/cam_view_1'
    os.system('mkdir -p ' + des_dir)
...
elif args.cam_view == 2: # upper right corner
    des_dir = '../test_carrots/cam_view_2'
    os.system('mkdir -p ' + des_dir)
    # cam_height = 6.0 * global_scale / 9.0
    # camPos = np.array([cam_height/4, cam_height, -cam_height/4])
...
elif args.cam_view == 3: # upper left corner
    des_dir = '../test_carrots/cam_view_3'
    os.system('mkdir -p ' + des_dir)
    # cam_height = 6.0 * global_scale / 9.0
    # camPos = np.array([-cam_height/4, cam_height, -cam_height/4])
    # camAngle = np.array([-np.deg2rad(130.), -np.deg2rad(70.), np.deg2rad(45.)])
